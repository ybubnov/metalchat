...
#define __lib_metalchat_concatenate4(s1, s2, s3, s4) \
    __lib_metalchat_stringify(s1##_##s2##_##s3##_s4)
...
/// A macro renders the function prototype of a metal kernel with mixed precision
...
#define __lib_metalchat_kernel2_mixed(function_name, type1, type2)                    \
    template [[host_name(__lib_metalchat_concatenate3(function_name, type1, type2))]] \
    kernel void                                                                       \
    function_name<type1, type2>(                                                      \
        __##function_name##_parameters<type1, type2>, uint2, uint2, uint2             \
    )
